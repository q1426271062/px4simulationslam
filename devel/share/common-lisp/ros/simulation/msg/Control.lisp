...
(cl:defmethod cl:initialize-instance :after ((m <Control>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Control)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simulation-msg:<Control> is deprecated: use simulation-msg:Control instead.")))
...
(cl:defmethod steer-val ((m <Control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation-msg:steer-val is deprecated.  Use simulation-msg:steer instead.")
  (steer m))

(cl:ensure-generic-function 'shift_gears-val :lambda-list '(m))
(cl:defmethod shift_gears-val ((m <Control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader simulation-msg:shift_gears-val is deprecated.  Use simulation-msg:shift_gears instead.")
  (shift_gears m))
